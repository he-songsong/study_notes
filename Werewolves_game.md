# 狼队
## 整体思路
1. 拉票：分析外置位好人找狼习惯，如果按照对方的找狼习惯已经确定拉不回来，就直接打死这张牌
2. 盘狼坑
   1) 如果已经被点入狼坑，不要说自己是好人所以对方狼坑有问题或者点不齐，没有说服力，直接跳神身份攻击对方狼坑爆炸，比如跳女巫给同在狼坑里的牌发银水
3. 警上工作，可以暗调神牌，如果对自己有敌意的可能是神，对自己没敌意且不敢攻击的是平民
...
### 发言逻辑
### 伪逻辑/强打
> 伪逻辑玩的不好的好人和狼人都有可能发出这种言论，常见的伪逻辑包括边角位、左二右二必开狼之类的位置学，
> 不能用位置学来找狼，但是可以用位置学来钓鱼执法，比如给其他人上压力，或者首置位发言创造谈资
- 连狼必有连神：从概率学角度上来说连狼后连神和连平民的可能性大

### 正逻辑
> 基于游戏规则、已知信息和直接证据进行的常规推理。它通常从“表面现象”出发，假设玩家的行为与身份一致  
- A攻击或者放逐投票给B，B出局后证明确实是狼人，那么正逻辑可能会推断A是好人
- 通灵师发对神职身份力度大
- 预言家夜晚吃刀倒牌所以是真预

### 反逻辑
> 从相反角度或逆向思维进行的推理，常用于怀疑“表面现象”是否在欺骗。反逻辑会考虑玩家可能在演戏、伪装或设置陷阱，从而得出与正逻辑相反的结论
- 比如盘狼人开局没有必要把自己放在焦点位上就是典型的反逻辑
- 如果是狼，前置位预言家验人力度大的情况下没必要起跳
...
### 铁逻辑
> 狼人杀中无可辩驳的逻辑规则，如果有人不遵守一局游戏是玩不下去的
- 点不齐狼坑或者狼坑爆炸
- 非机械狼板子中对跳女巫互毒单死，活下来的是真女巫
- 金水自爆一定不是真预言家
- 接预言家警徽的一定是其验出来的金水或者明好人
- 预言家验人未倒排情况下，查杀先置位发言，金水后置位发言，前后人数相同时下顺金逆杀

# 分析案例
## 1
- 警上1号牌首置位发言，本来想警上发挥，但没机会了
- 2号牌攻击1号牌说自己想要操作时有做身份的迹象，对1号牌身份不确定，警下太憋屈想上警发言
- 3号牌给了1/2不见面，但觉得2曲解了1的发言，所以2偏差
- 4号牌跳预言家给1发查杀，同时警徽流验3，点评3攻击2且抬高1身份所以对3有敌意
- 5号牌觉得4还行，对3有敌意，打出1/2/3可能3狼结构
- 6号牌觉得4不像预言家，因为攻击了像好人牌的3号，觉得3攻击2号牌的逻辑能理解，但觉得2号牌心态上偏好，对1/4/5都有敌意
点评：6号牌为什么得是爆水好人
